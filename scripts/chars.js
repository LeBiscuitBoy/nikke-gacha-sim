...
const characters = [
    ...
    new Character("Mari", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Jill", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Power", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Raven", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Asuka", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Emilia", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Makima", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Rei Ayanami", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Asuka: WILLE", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
    new Character("Rei Ayanami (Tentative Name)", false, Character.Rarities.SSR, Character.Manufacturers.Abnormal, false, true),
                        
    new Character("Ade", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Bay", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Rei", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    ...
    new Character("Clay", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    ...
    new Character("Nero", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Noir", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Milk", true, Character.Rarities.SSR, Character.Manufacturers.Tetra),
    new Character("Soda", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    ...
    new Character("Moran", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Cocoa", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Blanc", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Leona", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Alice", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Crust", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Sugar", true, Character.Rarities.SSR, Character.Manufacturers.Tetra),
    new Character("Viper", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    ...
    new Character("Rouge", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Rupee", true, Character.Rarities.SSR, Character.Manufacturers.Tetra),
    new Character("Bready", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Rumani", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Volume", true, Character.Rarities.SSR, Character.Manufacturers.Tetra),
    new Character("Sakura", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Biscuit", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Rosanna", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    ...
    new Character("Ade: Agent Bunny", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Mica: Snow Buddy", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Mary: Bay Goddess", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Milk: Blooming Bunny", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Rosanna: Chic Ocean", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Soda: Twinkling Bunny", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Rupee: Winter Shopper", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Alice: Wonderland Bunny", true, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Ludmilla: Winter Owner", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Anis: Sparkling Summer", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    new Character("Sakura: Bloom In Summer", false, Character.Rarities.SSR, Character.Manufacturers.Tetra, false, true),
    
    new Character("Rapi: Red Hood", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, true, true),
    new Character("K", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("D", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Brid", true, Character.Rarities.SSR, Character.Manufacturers.Elysion),
    new Character("Mast", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Poli", true, Character.Rarities.SSR, Character.Manufacturers.Elysion),
    new Character("Sora", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Zwei", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Emma", true, Character.Rarities.SSR, Character.Manufacturers.Elysion),
    new Character("Helm", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Quiry", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Vesti", true, Character.Rarities.SSR, Character.Manufacturers.Elysion),
    new Character("Arcana", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    ...
    new Character("Phantom", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    ...
    new Character("Marciana", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    new Character("Guillotine", true, Character.Rarities.SSR, Character.Manufacturers.Elysion),
    new Character("D: Killer Wife", true, Character.Rarities.SSR, Character.Manufacturers.Elysion, false, true),
    ...
    new Character("Ein", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    new Character("Tia", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    ...
    new Character("Mana", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    new Character("Mori", true, Character.Rarities.SSR, Character.Manufacturers.Missilis),
    new Character("Naga", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    new Character("Sin", false, Character.Rarities.SSR, Character.Manufacturers.Missilis),
    new Character("Tove", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    ...
    new Character("Elegg", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    new Character("Flora", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    ...
    new Character("Trina", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    new Character("Trony", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    new Character("Epinel", true, Character.Rarities.SSR, Character.Manufacturers.Missilis),
    new Character("Jackal", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    ...
    new Character("Laplace", true, Character.Rarities.SSR, Character.Manufacturers.Missilis, false, true),
    ...
    new Character("Grave", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    ...
    new Character("Dorothy", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Nayuta", false, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Scarlet", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim),
    new Character("Modernia", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Rapunzel", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim),
    new Character("Red Hood", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Liberalio", false, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Snow White", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim),
    new Character("Cinderella", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Nihilister", false, Character.Rarities.SSR, Character.Manufacturers.Pilgrim),
    new Character("Little Mermaid", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Rapunzel: Pure Grace", false, Character.Rarities.SSR, Character.Manufacturers.Pilgrim),
    new Character("Scarlet: Black Shadow", true, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
    new Character("Dorothy: Serendipity", false, Character.Rarities.SSR, Character.Manufacturers.Pilgrim, false, true),
